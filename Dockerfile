...
RUN cargo build --release -p w9-db-server &&     cp target/release/w9-db-server /usr/local/bin/appserver &&     chmod +x /usr/local/bin/appserver &&     ls -la /usr/local/bin/appserver
